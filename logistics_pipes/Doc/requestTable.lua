...
Description: \
Asks for all craftable ItemIdentifier inside the Logistics Network",
    "---------------------------------\
Command: getAvailableItems\
Parameter: NONE\
Return Type: java.util.List\
Description: \
Asks for all available ItemIdentifier inside the Logistics Network",
    "---------------------------------\
Command: makeRequest\
Parameter: \
ItemIdentifierStack\
...
Description: \
Requests the given ItemIdentifierStack",
    "---------------------------------\
Command: makeRequest\
Parameter: \
ItemIdentifierStack, Boolean\
Return Type: [Ljava.lang.Object;\
Description: \
Requests the given ItemIdentifierStack",
    "---------------------------------\
Command: makeRequest\
Parameter: \
ItemIdentifier, Double\
Return Type: [Ljava.lang.Object;\
Description: \
Requests the given ItemIdentifier with the given amount",
    "---------------------------------\
Command: makeRequest\
Parameter: \
ItemIdentifier, Double, Boolean\
Return Type: [Ljava.lang.Object;\
Description: \
Requests the given ItemIdentifier with the given amount",
    "---------------------------------\
Command: getItemAmount\
Parameter: \
ItemIdentifier\
Return Type: int\
Description: \
Asks for the amount of an ItemIdentifier Id inside the Logistics Network",
    "---------------------------------\
Command: canAccess\
Parameter: NONE\
Return Type: boolean\
